...
| Phase 1 — knowledge, intake, chat | 16 `done` · 17 `in_progress` (17C only) · 18–21 `done` · **22 in progress** | see §2 |
...
| Task | Needs | Notes |
|---|---|---|
| **22** Trip chat intake tools | 18–21 `done` | Status-gated `update_trip_brief` / `answer_clarification`; sync with brief form |
