...
| 27 | [Research chat tools and evaluation](27-research-chat-evaluation.md) | 22, 25, 26 | `review` | Branch `cursor/task-27-research-chat-eval-15b0`. Status-gated C2 chat tools (`start_research`, status/summary/select/guide/apps); SSE `research_started` / `destination_selected`; research-complete mail (V26 idempotent stamp); eval harness S4-9. Handoff: [`docs/RESEARCH-CHAT-EVAL-HANDOFF.md`](../docs/RESEARCH-CHAT-EVAL-HANDOFF.md). |
