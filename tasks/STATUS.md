...
| 17 | **17B** | Hybrid retrieval — vector + `tsvector` fusion, shared adapter contract tests | `not_started` — adapter contract tests done (**F-32**), seed validator done (**F-44**); the fusion itself remains |
