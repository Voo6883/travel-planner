...
| ~~**F-42**~~ | **Resolved (task 19 remainder).** `surprise_me` (UC-C1-05) is persisted by V22 and lives on `TripBriefDetails`, `TripBrief`, OpenAPI, and the `trip_brief` row; extraction now saves the same details it returns |
